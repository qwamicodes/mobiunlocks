    ...
    document.querySelector(el).addEventListener('submit', e => {
        ...
        switch (e.target.id) {
            case 'form-carrier':
                ...
                new controller.Pay('carrier', phoneModel, modelName, carNetwork, carImei).calcPrice().updateState().insertPay();
            ...
            case 'form-imei':
                ...
                //parsing the values into the a class that take care of the price and showing to UI
                new controller.Pay('imei', null, null, imeiNetwork, imeiImei).calcPrice().updateState().insertPay();
            ...
            case 'form-unlocking':
                ...
                //parsing the values into the a class that take care of the price and showing to UI
                new controller.Pay('unlocking', unlockingModel, modName, null, unlockingImei).calcPrice().updateState().insertPay();
